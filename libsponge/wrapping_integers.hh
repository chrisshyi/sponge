...
class WrappingInt32 {
  ...
  public:
    ...
    explicit WrappingInt32(uint32_t raw_value) : _raw_value(raw_value) {} // not a default constructor! 
    // Move constructor and assignment operator will still be generated by compiler
